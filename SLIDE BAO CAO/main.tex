...
\begin{frame}
  \todo{Thêm slide number cho các slides}
  \titlepage
\end{frame}
...
\begin{frame}
  ...
  \begin{minipage}{0.59\linewidth}
    ...
    \item Một số vấn đề
      ...
      \item Thời gian nghiên cứu \todo{Tìm cách nói rõ hơn}
      \item Đánh giá, xếp hạng
      \end{itemize}
    \item Giải pháp
      \begin{itemize}
      \item Công cụ hỗ trợ tự động \todo{Không lặp lại những nội dung bên dưới, vì đó là các vấn đề cần giải quyết ở trên}
      	\begin{itemize}
      	\item So sánh hai giải pháp
      	\item Tương đương hay tương tự
      	\item Đánh giá, xếp hạng giải pháp
    	\end{itemize}
      \item Đo được độ tương tự về hành vi giữa hai chương trình \todo{Tách riêng ý này thành một block dưới cùng để chú ý}
      \end{itemize}
    \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
  	...
  	\end{itemize}
  	\item Do tôi tự xây dựng. \todo{Tự xây dựng}
  \end{itemize}
\end{frame}
